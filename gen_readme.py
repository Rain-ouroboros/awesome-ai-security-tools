...
SECTIONS.append((
    ...
    [
        ("Scanners & Auditors", [
            ...
            {"name": "SkillSpector", "repo": "NVIDIA/SkillSpector", "tags": "🟢", "org": "NVIDIA",
             "desc": "Security scanner for AI-agent skills used by Claude Code, Codex CLI, Gemini CLI, and similar ecosystems; combines static analysis, AST/YARA/taint checks, optional LLM semantic review, MCP least-privilege/tool-poisoning checks, risk scoring, and SARIF/JSON/Markdown output.",
             "related": [SKILL_SCANNER, ("skilltotal", GH + "pezhik/skilltotal"), AGENT_SCAN, MCP_SCANNER]},
            {"name": "Ramparts", "repo": "highflame-ai/ramparts", "tags": "🟢",
             "desc": "Rust scanner for MCP servers and agent-skill bundles with YARA rules, optional LLM analysis, OSV/CVE lookups, OWASP MCP Top 10 mapping, and SARIF/JSON/Markdown reports.",
             "related": [("SkillSpector", GH + "NVIDIA/SkillSpector"), SKILL_SCANNER, MCP_SCANNER]},
            {"name": "mcp-armor", "repo": "aira-security/mcp-armor", "tags": "🟢", "org": "Aira Security",
             "desc": "Local MCP security scanner with auto-discovery for agentic IDE configs, tool/resource/prompt inventory, prompt-injection checks, rug-pull and tool-poisoning detection, baseline drift monitoring, and JSON/Markdown reports.",
             "related": [("SkillSpector", GH + "NVIDIA/SkillSpector"), ("Ramparts", GH + "highflame-ai/ramparts"), MCP_SCANNER]},
        ...
        ("Runtime Protection & Enforcement", [
            {"name": "ToolHive", "repo": "stacklok/toolhive", "tags": "🟢", "org": "Stacklok",
             "desc": "Platform for running MCP servers in isolated containers with per-request identity/access policy, registry and gateway workflows, audit logs, Kubernetes operator support, and observability hooks.",
             "related": [("microsandbox", GH + "superradcompany/microsandbox"), ("defenseclaw", GH + "cisco-ai-defense/defenseclaw")]},
            {"name": "Pipelock", "repo": "luckyPipewrench/pipelock", "tags": "🟢",
             ...
             "related": [("ToolHive", GH + "stacklok/toolhive"), ("mcp-context-protector", GH + "trailofbits/mcp-context-protector")]},
            {"name": "mcp-context-protector", "repo": "trailofbits/mcp-context-protector", "tags": "🟢", "org": "Trail of Bits",
             "desc": "MCP security wrapper that sits in front of downstream MCP servers, scans tool responses with guardrail providers, and supports quarantine/review workflows for desktop and coding-agent MCP configs.",
             "related": [MCP_SCANNER, ("ToolHive", GH + "stacklok/toolhive"), ("Pipelock", GH + "luckyPipewrench/pipelock")]},
            {"name": "MCP Defender", "repo": "MCP-Defender/MCP-Defender", "tags": "🟢⚠️",
             ...
             "related": [("ToolHive", GH + "stacklok/toolhive"), ("mcp-context-protector", GH + "trailofbits/mcp-context-protector")]},
            {"name": "MCP Gateway", "repo": "lasso-security/mcp-gateway", "tags": "🟢", "org": "Lasso Security",
             "desc": "Plugin-based MCP gateway that proxies configured MCP servers, sanitizes sensitive request/response data, supports guardrail plugins such as basic masking and Presidio, and runs a server reputation/risk check before loading MCP servers.",
             "related": [("ToolHive", GH + "stacklok/toolhive"), ("Pipelock", GH + "luckyPipewrench/pipelock"), ("mcp-context-protector", GH + "trailofbits/mcp-context-protector")]},
            {"name": "Parallax", "repo": "agent-defense/parallax", "tags": "🟢",
             ...
             "related": [("Pipelock", GH + "luckyPipewrench/pipelock"), ("Armorer Guard", GH + "ArmorerLabs/Armorer-Guard")]},
            ...
            {"name": "h5i", "repo": "h5i-dev/h5i", "tags": "🟢",
...
SECTIONS.append((
    ...
    [
        ("Scanners, Evals & Guardrails", [
            ...
            {"name": "HackAgent", "repo": "AISecurityLab/hackagent", "tags": "🟢",
             ...
             "related": [("PyRIT", GH + "microsoft/PyRIT"), ("garak", GH + "NVIDIA/garak"), ("agentic_security", GH + "msoedov/agentic_security")]},
            {"name": "HiveTrace Red", "repo": "HiveTrace/HiveTraceRed", "tags": "🟢",
             ...
             "note": "— **note:** young project with limited independent adoption signal.",
             "related": [("garak", GH + "NVIDIA/garak"), ("PyRIT", GH + "microsoft/PyRIT"), ("promptfoo", GH + "promptfoo/promptfoo")]},
            ...
            {"name": "PINT Benchmark", "repo": "lakeraai/pint-benchmark", "tags": "🟢🔬", "org": "Lakera",
             "desc": "Prompt-injection test benchmark for evaluating detectors and guardrails across multilingual prompt injection, jailbreak, benign, and hard-negative inputs.",
             "related": [("Open-Prompt-Injection", GH + "liu00222/Open-Prompt-Injection"), ("Prompt Guard 86M", HF + "meta-llama/Prompt-Guard-86M")]},
            {"name": "PIArena", "repo": "sleeepeer/PIArena", "tags": "🟢🔬",
             "desc": "ACL 2026 toolbox and benchmark for prompt-injection attacks and defenses, with ready-to-use attacks/defenses, evaluation pipelines, agent benchmarks, a Hugging Face dataset, and leaderboard.",
             "related": [("PINT Benchmark", GH + "lakeraai/pint-benchmark"), ("Open-Prompt-Injection", GH + "liu00222/Open-Prompt-Injection")]},
